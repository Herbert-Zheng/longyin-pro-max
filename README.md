...
- 黄鹤楼完成一次原版“物色人选”后，候选窗口会显示“刷新候选人”按钮；按钮沿用本次物色的类型、人数和等级重新生成候选，并清理被丢弃的临时候选，不重复消耗物色所需时间。
- 门派、看板和官府委托各有独立开关；开启后复用原版委托刷新按钮和原版清空重建流程，但不会耗尽当月刷新次数。未知委托与 NPC 委托保持原版行为。
