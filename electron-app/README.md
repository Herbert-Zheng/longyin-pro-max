...
- 在“交易与制造”中配置默认开启的“刷新打造词条按钮”；它只在普通打造或特殊强化候选界面显示，不会自动打造或消耗材料，保存后需重启游戏生效
- 在“交易与制造”中配置默认开启的官府仓库刷新功能；游戏内按钮文字为“刷新”，快捷键仅在官府仓库页面可见时生效
- 在“探索与大地图”的“城内事务刷新”中分别控制黄鹤楼候选人、门派委托、看板委托和官府委托刷新；黄鹤楼与委托刷新各有一个仅在对应窗口生效的快捷键，默认均为 `R`，保存后需重启游戏生效
- 安装和卸载随包提供的 `dist/` 载荷
