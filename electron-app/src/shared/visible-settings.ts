...
export function sanitizeVisibleSettings(input: VisibleSettings): VisibleSettings {
  ...
  return {
    ...
    treasurePavilionCapacityMultiplier: clamp(input.treasurePavilionCapacityMultiplier, 0.1, 999),
    ...
    continuousBookCombineEnabled: input.continuousBookCombineEnabled,
    ...
    bountyContributionMultiplier: clamp(input.bountyContributionMultiplier, 0, 999),
    batchAreaUpgradeEnabled: input.batchAreaUpgradeEnabled,
